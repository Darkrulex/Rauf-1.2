...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Darkrulex/Rauf-1.2/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Rauf-Ali\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mThanks To My Mind Rauf-Ali\x1b[1;91m'
    print 47 * '-'
